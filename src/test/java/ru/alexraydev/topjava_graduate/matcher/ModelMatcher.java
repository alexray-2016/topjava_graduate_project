package ru.alexraydev.topjava_graduate.matcher;

import org.junit.Assert;
import org.springframework.test.web.servlet.ResultActions;
import org.springframework.test.web.servlet.ResultMatcher;
import ru.alexraydev.topjava_graduate.TestUtil;
import ru.alexraydev.topjava_graduate.util.json.JsonUtil;
...
public class ModelMatcher<T> {
    ...
    public static <T> ModelMatcher<T> of(Class<T> entityClass, Equality<T> equality) {
        return new ModelMatcher<T>(entityClass, equality);
    }
